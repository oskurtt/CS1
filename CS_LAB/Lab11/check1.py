...
class BallDraw(object):
    def __init__ (self, parent, x=80, y=200, dx=6, dy=-3, radius=10, color='red'):
        ...
        self.ball_x,self.ball_y = b.position()    # initial location
        self.ball_radius = b.radius
        self.ball_dx,self.ball_dy = b.dx, b.dy    # the movement of the ball object
